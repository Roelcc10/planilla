<select name="department" onchange="cambia()" class="form-control" required="">
...
<select class="form-control" name="province" onchange="cambiaDistrito()" required="">
    <option>Seleccione la Provincia</option>
</select>
<select class="form-control" name="district" required=""><option>Seleccione el Distrito</option>
</select>
</div>
...
<script>
    function cambia()
    {
        ...
        var sel_departamento = document.getElementsByName("department")[0];
        var sel_provincia = document.getElementsByName("province")[0];
        var sel_distrito = document.getElementsByName("district")[0];
        ...
        department = sel_departamento.options[sel_departamento.selectedIndex].value;

        if(department!=0)
        {
            mis_opts=eval("opt_" + department);
            mis_value=eval("opt_" + department +"_value");
    ...
    function cambiaDistrito()
    {
        ...
        province = sel_provincia.options[sel_provincia.selectedIndex].value;
        if(province!=0)
        {
            mis_opts=eval("opt_" + province);
            num_opts=mis_opts.length;
