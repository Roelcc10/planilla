                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                        <tr>
                          ...
                          <td>13:00 AM <span class=\"label label-orange pull-right\">receso</span></td>
                          <td>14:00 PM <span class=\"label label-green pull-right\">online</span></td>
                          <td>".date('h:i A', strtotime($row['time_out']))." <span class=\"label label-offline pull-right\">offline</span></td>
                          <td>
...
$(function(){
  ...
  $('.delete').click(function(e){
    ...
    $('#attedance').click(function(e){
        e.preventDefault();
        $('#attedance').attr('action', 'attedance_generate.php');
        $('#attedance').submit();
    });
});
