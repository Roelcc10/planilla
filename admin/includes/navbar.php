<header class="main-header">
    ...
    <a href="home.php" class="logo">
      ...
      <span class="logo-lg"><b></b>Control de Asistencia</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo (!empty($user['photo'])) ? '../images/'.$user['photo'] : '../images/1614273532.jpg'; ?>" class="user-image" alt="User Image">
