                            ...
                            ";
                                ...
                                <tr>
                                    ...
                                    while($checksday = $checks->fetch_assoc()){
                                        ...
                                        $schedule = $conn->query($schedules);
                                        echo "
                                   <td> <br>";
                                        echo " <select name='horarioweek[]'>";
                                        echo "<option selected value='{$checksday['name']}-0'>select</option>";
                                        while ($sche = $schedule->fetch_assoc()) {
                                            echo"
                                   
                                      <option value='{$checksday['name']}-{$sche['id']}'>{$sche['time_in']}</option>
