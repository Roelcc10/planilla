        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-orange"> 
            <div class="inner">
              ...
              <p>Elegir tipo de empresa</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-stalker"></i> 
            </div>
            <a href="http://127.0.0.1:8000/admin/teams" class="small-box-footer">Ver más <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              ...
              <p>Buscar empleados por empresa</p>
            </div>
            <div class="icon">
